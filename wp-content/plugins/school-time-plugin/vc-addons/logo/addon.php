...
class ST_Logo extends WPBakeryShortCode {
	...
	*/
	public function render( $atts, $content = null ) {
		...
		if ( function_exists( 'school_time_get_logo_url' ) ) {
		...
		if ( function_exists( 'school_time_get_option' ) ) {
			$logo_width_settings = school_time_get_option( 'logo-width-exact', '' );
		...
		$html = '<img class="vc_img-placeholder vc_single_image-img" src="' . $logo_url . '" alt="' . $logo_alt_text . '"/>';
