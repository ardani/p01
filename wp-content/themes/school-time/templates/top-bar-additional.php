<?php
$top_bar_additional_text = school_time_get_option( 'top-bar-additional-text', '' );
$logo_location           = school_time_get_option( 'logo-location', 'main_menu' );
$use_logo                = $logo_location == 'top_bar_additional' ? true : false;
 ?>
<div class="<?php echo school_time_class( 'top-bar-additional' ); ?>">
	<div class="<?php echo school_time_class( 'container' ); ?>">
		...
		<?php if ( $top_bar_additional_text ): ?>
			<div class="<?php echo school_time_class( 'top-bar-additional-text' ); ?>">
